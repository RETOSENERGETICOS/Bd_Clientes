        ...
        <v-expansion-panel>
            ...
            <v-expansion-panel-content>
                ...
                <v-row>
                    ...
                    <v-col cols="4" v-if="filters.phone.active"><v-text-field v-model.number="filter.phone" label="Telefono Oficina/Office Phone" clearable></v-text-field></v-col>
                    
                    <v-col cols="4" v-if="filters.phone1.active"><v-text-field v-model.number="filter.phone1" label="Telefono Celular/Cell Phone" clearable></v-text-field></v-col>
                    ...
                    <v-col cols="4" v-if="filters.phonee.active"><v-text-field v-model.number="filter.phonee" label="Telefono Oficina/Office Phone" clearable></v-text-field></v-col>
                    <v-col cols="4" v-if="filters.phonee2.active"><v-text-field v-model.number="filter.phonee2" label="Telefono Celular/Cell Phone" clearable></v-text-field></v-col>
